...
# Configuration Script – 123 - Rev. A

This **Configuration** script is designed for the **123** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Configuration – 123 Rev. A

Este script de **Configuration** está diseñado para el modelo **123** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
